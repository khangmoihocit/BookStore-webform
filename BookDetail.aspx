<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookDetail.aspx.cs" Inherits="btl_laptrinhweb.BookDetail" %>
    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="product-info">
                ...
                <p>Mã sản phẩm: <span class="id">
                    <asp:Label ID="lblProductId" runat="server" /></span></p>
                <p>Tác giả: <span class="artis">
                    <asp:Label ID="lblAuthor" runat="server" /></span></p>
                <p>Tình trạng: <span class="status">
                    <asp:Label ID="lblStatus" runat="server" /></span></p>
    ...
    <script>
        ...
        images.forEach((img, index) => {
            img.addEventListener('click', () => {
                ...
                // Cập nhật class active cho ảnh đang hiển thị
